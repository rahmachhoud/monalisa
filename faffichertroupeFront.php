    ...
    <?php
        ...
        include '../../core/TroupeC.php';
         ...
         //$rec =new ReclamationC();
          $produitc=new TroupeC();
        $liste= $produitc->afficherTroupe();
if(isset($_POST['search']))
         { $val=$_POST['search'];
             $pe=new chanteurC();
             $liste=$pe->rechercherchanteurs($val);
             $liste=$pe->afficherTroupe();
 ...
 ?>
    ...
    <form name="form" > 
          	...
          	<select size="1" onChange="location = this.options[this.selectedIndex].value;">
          		<option value="faffichertroupeFront.php?faffichertroupeFront.php=1">Default</option>
          	 <option value="faffichertroupeFront.php?ProduitsTries=1" >id(low-high)</option> 
          	 <option value="faffichertroupeFront.php?ProduitsTriesDesc=1" >id(high-low)</option> 
          	  <option value="faffichertroupeFront.php?ProduitsTriesA=1" >Nom(A-Z)</option> 
          	  <option value="faffichertroupeFront.php?ProduitsTriesZ=1" >Nom(Z-A)</option> 
...
<div >
        ...
        <div class="slider__container slider--one">
            <div class="slider__activation__wrap owl-carousel owl-theme">
                <!-- Start Single Slide -->
                <div class="slide slider__full--screen" style="background: rgba(0, 0, 0, 0) url(images/rahma/m.jpg) no-repeat scroll center center / cover ;">
                ...
                <div class="container">
                        <div class="row">
                            ...
                            <h1>Troupe <span class="text--theme"> Boudinar</span></h1>
                                        
                                
                                    <div class="slider__btn">
                                    <a class="htc__btn" href="cart.html">Book now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- End Single Slide -->
                <!-- Start Single Slide -->
                <div class="slide slider__full--screen" style="background: rgba(0, 0, 0, 0) url(images/rahma/n.jpg) no-repeat scroll center center / cover ;">
                    <div class="container">
                        <div class="row">
                ...
                <!-- End Single Slide -->
                  <!-- Start Single Slide -->
                  <div class="slide slider__full--screen" style="background: rgba(0, 0, 0, 0) url(images/rahma/l.jpg) no-repeat scroll center center / cover ;">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                                <div class="slider__inner">
                                    <h1>Troupe<span class="text--theme"> Elhajji </span></h1>
                                    <div class="slider__btn">
                                        <a class="htc__btn" href="cart.html">Book now</a>
                                    </div>
                                </div>
                ...
                <!-- End Single Slide -->
                  <!-- Start Single Slide -->
                  <div class="slide slider__full--screen" style="background: rgba(0, 0, 0, 0) url(images/rahma/p.jpg) no-repeat scroll center center / cover ;">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                                <div class="slider__inner">
                                    <h1>Troupe<span class="text--theme"> Elhani </span></h1>
                                    <div class="slider__btn">
                                        <a class="htc__btn" href="cart.html">Book now</a>
                                    </div>
                                </div>
